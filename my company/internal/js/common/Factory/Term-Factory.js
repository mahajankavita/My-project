...
return Value;},userActualIncome:function($scope){$scope.userActualIncome=[];var Value=null;var Text='';var InitialValue=95000;for(i=InitialValue;i<10000000;){i=i+5000;if(i==10000000){Text=parseFloat(i/10000000).toFixed(0)+' Crore';}
else{Text=parseFloat(i/100000).toFixed(2)+' Lacs';}
$scope.userActualIncome.push({ActualIncomeText:Text});}
return $scope.userActualIncome;},userActualIncome1:function($scope){$scope.userActualIncome=[];var Value=null;var Text='';var InitialValue=95000;for(i=InitialValue;i<1000000;){i=i+5000;Text=parseFloat(i/100000).toFixed(2)+' Lacs';$scope.userActualIncome.push({ActualIncomeText:Text});}
...
return $scope;},convertincomeintotext:function($scope,value){var userfloatincome='';var count=value.toString().length;if(count==6||count==7){userfloatincome=parseFloat(value/100000).toFixed(2)+' Lacs';}
else if(count==8){userfloatincome=parseFloat(value/10000000).toFixed(0)+' Crore';}
